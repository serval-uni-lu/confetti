...
def create_standard_results_dataframe(
    ...
    return df[["Solution", "is_best" ,"Test Instance", "NUN Instance", "CE Label"]].reset_index(drop=True)


def run_confetti_counterfactuals(model_name=None, with_checkpoint: bool = False) -> None:
    """
    ...
    time_file = cfg.RESULTS_DIR / f"execution_time_confetti_{model_name}.csv"
...
def main():
    ...
    #run_confetti_counterfactuals(model_name="logistic")
