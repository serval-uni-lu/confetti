...
class CounterfactualProblem(ElementwiseProblem):
    def __init__(self, original_instance:np.array, nun_instance:np.array, nun_index:int, start_timestep:int, subsequence_length:int, classifier, y_pred_train):
    ...
    def _evaluate(self, x, out, *args, **kwargs):
        ...
        counterfactual[self.start_timestep:self.end_timestep][x_reshaped] = self.nun_instance[self.start_timestep:self.end_timestep][x_reshaped]   
